...
let allKeyEntries: [KeyEntry] = [
    KeyEntry(name: "A", scanCode: 0x1E), KeyEntry(name: "B", scanCode: 0x30),
    KeyEntry(name: "C", scanCode: 0x2E), KeyEntry(name: "D", scanCode: 0x20),
    KeyEntry(name: "E", scanCode: 0x12), KeyEntry(name: "F", scanCode: 0x21),
    KeyEntry(name: "G", scanCode: 0x22), KeyEntry(name: "H", scanCode: 0x23),
    KeyEntry(name: "I", scanCode: 0x17), KeyEntry(name: "J", scanCode: 0x24),
    KeyEntry(name: "K", scanCode: 0x25), KeyEntry(name: "L", scanCode: 0x26),
    KeyEntry(name: "M", scanCode: 0x32), KeyEntry(name: "N", scanCode: 0x31),
    KeyEntry(name: "O", scanCode: 0x18), KeyEntry(name: "P", scanCode: 0x19),
    KeyEntry(name: "Q", scanCode: 0x10), KeyEntry(name: "R", scanCode: 0x13),
    KeyEntry(name: "S", scanCode: 0x1F), KeyEntry(name: "T", scanCode: 0x14),
    KeyEntry(name: "U", scanCode: 0x16), KeyEntry(name: "V", scanCode: 0x2F),
    KeyEntry(name: "W", scanCode: 0x11), KeyEntry(name: "X", scanCode: 0x2D),
    KeyEntry(name: "Y", scanCode: 0x15), KeyEntry(name: "Z", scanCode: 0x2C),
    KeyEntry(name: "0", scanCode: 0x0B), KeyEntry(name: "1", scanCode: 0x02),
    KeyEntry(name: "2", scanCode: 0x03), KeyEntry(name: "3", scanCode: 0x04),
    KeyEntry(name: "4", scanCode: 0x05), KeyEntry(name: "5", scanCode: 0x06),
    KeyEntry(name: "6", scanCode: 0x07), KeyEntry(name: "7", scanCode: 0x08),
    KeyEntry(name: "8", scanCode: 0x09), KeyEntry(name: "9", scanCode: 0x0A),
    KeyEntry(name: "F1",  scanCode: 0x3B), KeyEntry(name: "F2",  scanCode: 0x3C),
    KeyEntry(name: "F3",  scanCode: 0x3D), KeyEntry(name: "F4",  scanCode: 0x3E),
    KeyEntry(name: "F5",  scanCode: 0x3F), KeyEntry(name: "F6",  scanCode: 0x40),
    KeyEntry(name: "F7",  scanCode: 0x41), KeyEntry(name: "F8",  scanCode: 0x42),
    KeyEntry(name: "F9",  scanCode: 0x43), KeyEntry(name: "F10", scanCode: 0x44),
    KeyEntry(name: "Space",       scanCode: 0x39),
    KeyEntry(name: "Enter",       scanCode: 0x1C),
    KeyEntry(name: "Escape",      scanCode: 0x01),
    KeyEntry(name: "Left Shift",  scanCode: 0x2A),
    KeyEntry(name: "Left Ctrl",   scanCode: 0x1D),
    KeyEntry(name: "Left Alt",    scanCode: 0x38),
    KeyEntry(name: "Arrow Up",    scanCode: 0x48),
    KeyEntry(name: "Arrow Down",  scanCode: 0x50),
    KeyEntry(name: "Arrow Left",  scanCode: 0x4B),
    KeyEntry(name: "Arrow Right", scanCode: 0x4D),
]
